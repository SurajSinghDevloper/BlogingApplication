...
const Home = (props) => {
  return (
    <>
      <div className="container-fluid cover-full col-12 py-4">
        <div className="row">
          <div className="col-12">
            <div className="jumbotron text-center">
              ...
              <p className="lead">
                ...
                ut augue neque. Integer sed fermentum tellus.
              </p>
              <hr className="my-4 text-center" col-3 />
              <p>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer
                ut metus a urna pharetra tincidunt.
              </p>
              <p className="lead">
